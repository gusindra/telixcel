        ...
        <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
            <nav>
                <ol class="flex flex-wrap pt-1 pl-2 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
                    ...
                    <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Teams</li>
                </ol>
                <h6 class="mb-2 ml-2 font-bold text-white capitalize">Teams</h6>
            </nav>
            ...
            <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                ...
                <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                    <li class="flex items-center">
                        <a href="../../../pages/authentication/signin/illustration.html" class="block px-0 py-2 font-semibold text-white transition-all ease-soft-in-out text-sm">
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex">
                                <div class="w-19 h-19 text-base ease-soft-in-out bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                    <img class="w-full" src="../../../assets/img/small-logos/logo-slack.svg" alt="Image placeholder" />
                                </div>
                                <div class="my-auto ml-4">
                                    <h6 class="dark:text-white">Slack Bot</h6>
                                    <div>
                                        ...
                                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30" data-target="tooltip_trigger">
                            ...
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-6/12 max-w-full px-3 flex-0">
                                    ...
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Participants</p>
                                </div>
                                <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">02.03.22</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Due date</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                    <div class="relative flex flex-col min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex">
                                <div class="w-19 h-19 text-base ease-soft-in-out bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                    <img class="w-full" src="../../../assets/img/small-logos/logo-spotify.svg" alt="Image placeholder" />
                                </div>
                                <div class="my-auto ml-4">
                                    <h6 class="dark:text-white">Premium support</h6>
                                    <div>
                                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30" data-target="tooltip_trigger">
                                            <img class="w-full rounded-circle" alt="Image placeholder" src="../../../assets/img/team-4.jpg" />
                                        </a>
                            ...
                            <p class="mt-4 leading-normal text-sm">Pink is obviously a better color. Everyone’s born confident, and everything’s taken away from you.</p>
                            <hr class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent" />
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-6/12 max-w-full px-3 flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">3</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Participants</p>
                                </div>
                                <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">22.11.21</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Due date</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                    <div class="relative flex flex-col min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex">
                                <div class="w-19 h-19 text-base ease-soft-in-out bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                    <img class="w-full" src="../../../assets/img/small-logos/logo-xd.svg" alt="Image placeholder" />
                                </div>
                                <div class="my-auto ml-4">
                                    <h6 class="dark:text-white">Design tools</h6>
                                    <div>
                                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30" data-target="tooltip_trigger">
                                            <img class="w-full rounded-circle" alt="Image placeholder" src="../../../assets/img/team-4.jpg" />
                                        </a>
                            ...
                            <p class="mt-4 leading-normal text-sm">Constantly growing. We’re constantly making mistakes from which we learn and improve.</p>
                            <hr class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent" />
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-6/12 max-w-full px-3 flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">4</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Participants</p>
                                </div>
                                <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">06.03.22</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Due date</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                    <div class="relative flex flex-col min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex">
                                <div class="w-19 h-19 text-base ease-soft-in-out bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                    <img class="w-full" src="../../../assets/img/small-logos/logo-asana.svg" alt="Image placeholder" />
                                </div>
                                <div class="my-auto ml-4">
                                    <h6 class="dark:text-white">Looking great</h6>
                                    <div>
                                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30" data-target="tooltip_trigger">
                                            <img class="w-full rounded-circle" alt="Image placeholder" src="../../../assets/img/team-3.jpg" />
                                        </a>
                            ...
                            <p class="mt-4 leading-normal text-sm">You have the opportunity to play this game of life you need to appreciate every moment.</p>
                            <hr class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent" />
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-6/12 max-w-full px-3 flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">6</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Participants</p>
                                </div>
                                <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">14.03.24</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Due date</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                    <div class="relative flex flex-col min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex">
                                <div class="w-19 h-19 text-base ease-soft-in-out bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 inline-flex items-center justify-center rounded-lg p-2 text-white transition-all duration-200">
                                    <img class="w-full" src="../../../assets/img/small-logos/logo-invision.svg" alt="Image placeholder" />
                                </div>
                                <div class="my-auto ml-4">
                                    <h6 class="dark:text-white">Developer First</h6>
                                    <div>
                                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30" data-target="tooltip_trigger">
                                            <img class="w-full rounded-circle" alt="Image placeholder" src="../../../assets/img/team-4.jpg" />
                                        </a>
                            ...
                            <p class="mt-4 leading-normal text-sm">For standing out. But the time is now to be okay to be the greatest you.</p>
                            <hr class="h-px mx-0 my-4 bg-transparent border-0 opacity-25 bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent" />
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-6/12 max-w-full px-3 flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">4</h6>
                                ...
                                <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                    <h6 class="mb-0 leading-normal text-sm">16.01.22</h6>
                                    <p class="mb-0 font-semibold leading-normal text-sm text-slate-400">Due date</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
                    <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                        <div class="leading-normal text-center copyright text-sm text-slate-500 lg:text-left">
                            ...
                            <a href="https://www.creative-tim.com" class="font-semibold text-slate-700 dark:text-white" target="_blank">Telixcel Tim</a>.
                        </div>
                    </div>
