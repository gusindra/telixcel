    ...
    <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
        <nav>
            <ol class="flex flex-wrap pt-1 pl-2 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Costumer</li>
            </ol>
                ...
                <div class="relative right-0">
                    <ul class="relative flex p-1 list-none bg-transparent rounded-xl" role="list">
                        <li class="z-30 flex-auto text-center">
                            <a class="z-30 block w-full px-1 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700" nav-link active href="{{route('project')}}?v=1&companyid={{$user->id}}" role="tab" aria-selected="true">
                        ...
                        <li class="z-30 flex-auto text-center">
                            <a class="dark:text-white border z-30 block w-full px-1 py-1 mb-0 transition-all rounded-lg ease-soft-in-out bg-inherit text-slate-700" nav-link href="{{route('project')}}?v=1&companyid={{$user->id}}" role="tab" aria-selected="false">
                                ...
                                <span class="ml-1 text-sx">Customer</span>
                            </a>
                        </li>
                        <li class="z-30 flex-auto text-center">
                            <a class="z-30 block w-full px-1 py-1 mb-0 transition-colors border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700" nav-link href="javascript:;" role="tab" aria-selected="false">
                                ...
                                <span class="ml-1 text-sx">Settings</span>
                            </a>
                        </li>
                    </ul>
                </div>
