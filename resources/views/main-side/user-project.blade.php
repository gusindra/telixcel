                    ...
                    <div class="relative right-0">
                        <ul class="relative flex p-1 list-none bg-transparent rounded-xl" role="list">
                            <li class="z-30 flex-auto text-center">
                                <a class="border z-30 block w-full px-1 py-1 mb-0 transition-all rounded-lg ease-soft-in-out bg-inherit text-slate-700 dark:text-white" nav-link active href="{{route('project')}}?v=1&companyid={{$user->id}}" role="tab" aria-selected="true">
                            ...
                            <li class="z-30 flex-auto text-center">
                                <a class="z-30 block w-full px-1 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700" nav-link href="{{route('client')}}?v=1&companyid={{$user->id}}" role="tab" aria-selected="false">
