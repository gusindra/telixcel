<div>
    ...
    <div id="messageArea" class="lg:max-h-screen">
        ...
        @if($client)
        <div class="bg-gray-200 z-10 dark:bg-slate-700 py-1 grid grid-cols-9 lg:static md:static sm:fixed sm:inset-x-0 sm:bottom-0">
            <div class="flex items-center col-span-1 align-text-bottom pl-2">
            ...
            <div data-emojiarea data-type="unicode" data-global-picker="false" class="md:flex py-2 col-span-6 pr-2" >
                <div class="emoji-button cursor-pointer text-sm text-grey-500 dark:text-slate-300 p-1">
                    😄
                </div>
                <textarea
                    id="message"
