<div class="{{$cid?'block':'hidden1'}}">
    ...
    <div id="messageArea" class="lg:max-h-screen">
        ...
        <div class="bg-gray-200 z-10 dark:bg-slate-700 py-1 grid grid-cols-8 lg:static md:static sm:fixed sm:inset-x-0 sm:bottom-0" data-emojiarea data-type="unicode" data-global-picker="false">

            <div class="flex items-center col-span-1 align-text-bottom">
            ...
            <div data-emojiarea data-type="unicode" data-global-picker="false" class="md:flex py-2 col-span-6 pr-2" >
                <div class="flex items-center col-span-1 align-text-bottom emoji-button cursor-pointer text-sm text-grey-500 dark:text-slate-300 p-1">
                    <button class="cursor-pointer text-sm text-grey-500 dark:text-slate-300 p-1" >😄</button>
                </div>
                <textarea
                    id="message"
                    class="mt-1 block w-full text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm dark:bg-slate-800 dark:text-slate-300"
