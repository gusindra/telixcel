                    ...
                    @foreach ($approvals as $approval)
                        <li class=" {{$approval->status!=null ? 'border-l-2 border-blue-600':'border-gray-300'}} pl-6 pb-4">
                            ...
                            @elseif($approval->status!='submited')
                                <div class="2 absolute w-6 h-6 {{$approval->status==null ? 'bg-gray-300 dark:bg-slate-600':'bg-blue-600'}} rounded-full -left-3 border border-white dark:border-blue-900 dark:bg-blue-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="m-auto mt-1 h-3 w-3 text-white" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                                    </svg>
                                </div>
                            @else
                                <div class="3 absolute w-6 h-6 {{$approval->status==null ? 'bg-gray-300':'bg-blue-600'}} rounded-full -left-3 border border-white dark:border-blue-900 dark:bg-blue-700">
                            ...
                            <div class="flex gap-2 justify-between">
                                <h3 class="mt-0 text-sm font-semibold text-gray-900 dark:text-white capitalize">{{$approval->status!='submited' ? $approval->role->name : $approval->user->name}}</h3>
