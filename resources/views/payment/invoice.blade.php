<!DOCTYPE html>
<!-- saved from url=(0062)file:///C:/Users/HOME/Desktop/Jarvis%20Store/2022/Invoice.html -->
<html>
    ...
    <head>
        ...
        <title>Invoice</title>
        <script src="../../invoice/nr-1044.min.js.download"></script>
        <script src="../../invoice/nr-1044.min.js(1).download"></script>
        <script src="../../invoice/nr-1044.min.js(2).download"></script>
        <script src="../../invoice/nr-1044.min.js(3).download"></script>
        <script type="text/javascript" src="../../invoice/bd029fa6f5"></script>
        <script src="../../invoice/nr-1044.min.js(4).download"></script>
        <script src="../../invoice/rCpcMYTJPZbw9c7LGRfp_htvwDc.js.download"></script>
        <script src="file:///C:/cdn-cgi/apps/body/UFhp1tsqH9DlQWwpXguyNTFzbxY.js"></script>
        <script src="file:///C:/cdn-cgi/apps/body/UFhp1tsqH9DlQWwpXguyNTFzbxY.js"></script>
        <script src="file:///C:/cdn-cgi/apps/body/UFhp1tsqH9DlQWwpXguyNTFzbxY.js"></script>
        <script src="file:///C:/cdn-cgi/apps/body/UFhp1tsqH9DlQWwpXguyNTFzbxY.js"></script>
        <script src="../../invoice/UFhp1tsqH9DlQWwpXguyNTFzbxY.js.download"></script>
        <link media="all" type="text/css" rel="stylesheet" href="../../invoice/invoice-style-2.min.css">
        <link rel="license" href="https://www.opensource.org/licenses/mit-license/">
        <script src="../../invoice/invoice-script.js.download"></script>
        <link rel="apple-touch-icon" sizes="60x60" href="https://s3.ap-southeast-1.amazonaws.com/cdn2.jarvis-store.com/frontend/version/2/favicon/apple-icon-60x60.png">
        <link rel="icon" type="image/png" sizes="32x32" href="https://s3.ap-southeast-1.amazonaws.com/cdn2.jarvis-store.com/frontend/version/2/favicon/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="96x96" href="https://s3.ap-southeast-1.amazonaws.com/cdn2.jarvis-store.com/frontend/version/2/favicon/favicon-96x96.png">
        <link rel="icon" type="image/png" sizes="16x16" href="https://s3.ap-southeast-1.amazonaws.com/cdn2.jarvis-store.com/frontend/version/2/favicon/favicon-16x16.png">
        <style type="text/css">
            :root topadblock,
            ...
            :root a[href^="https://someperceptionparade.com/"],
            ...
            :root a[href^="https://queersodadults.com/"],
            ...
            :root a[href^="https://nutrientassumptionclaims.com/"],
            ...
            :root a[href^="https://galaxyroms.net/?scr="],
    ...
    <body data-new-gr-c-s-check-loaded="14.1056.0" data-gr-ext-installed="" data-new-gr-c-s-loaded="14.1056.0">
        <div class="invoice-ribbon" style="width: 230px;height: 230px;overflow: hidden;position: absolute;top: 0;right: 0;">
            <div class="ribbon-inner" style="text-align: center;-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);-ms-transform: rotate(45deg);-o-transform: rotate(45deg);position: relative;padding: 15px 0px 15px;left: 21px;top: 36px;width: 270px;background-color: #36f43c;font-size: 24px;color: #fff;">
                PAID </div>
        </div>
        <header>
            <h1 class="title">payment receipt
            </h1>
            <div>
        ...
        <article>
            <table class="meta1">
                <tbody>
                    <tr>
                        <th><span contenteditable="">Transaction Ref </span></th>
                        <td><span contenteditable=""><span style="font-size: 10px;">PR2022000212</span><br></span></td>
                    </tr>
                    <tr>
                        <th><span contenteditable="">Payment Date</span></th>
                        <td><span contenteditable=""><a href="https://jarvis-store.com/jarvis-admin/billing/165/invoice" title="23:54"> 23 April 2022
                                </a></span></td>
                    </tr>
                    <tr>
                        <th><span contenteditable="">Payment Method</span></th>
                        <td> <span contenteditable="">Bank Transfer</span></td>
                    </tr>
                </tbody>
            </table>
            <br>
            <div contenteditable="">
                <h3>Invoice to</h3>
                <br>
                <p>Ardyan Vicky Ramadhan
                </p>
                <div class="normal-text">
                    <p>0851-5895-2558<br></p>
                </div>
            </div>
            <br>
                ...
                <tbody>
                    <tr>
                        <td><a class="cut">-</a><span contenteditable="">
                                Bug Konfirmasi Pembayaran</span></td>
                        <td><span contenteditable="">
                                - request post method menggunakan id acak untuk order</span></td>
                        <td><span data-prefix="">Rp</span> <span contenteditable="">100,000</span></td>
                    </tr>
                    <tr>
                        <td><a class="cut">-</a><span contenteditable="">
                                Bug Delete file AWS s3</span></td>
                        <td><span contenteditable="">
                                - permission delete file aws public</span></td>
                        <td><span data-prefix="">Rp</span> <span contenteditable="">200,000</span></td>
                    </tr>
                </tbody>
            </table>
            <a class="add">+</a>
            <table class="balance">
                <tbody>
                    <tr>
                        ...
                        <td><span data-prefix="">Rp</span> <span contenteditable="">300,000</span></td>
                    </tr>
                    <tr>
        ...
        <aside>
            <h1><span contenteditable="">Information</span></h1>
            <div>
                <p class="small-text" contenteditable="">
                    Payment No :&nbsp;<span style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 10px; font-style: normal;">PR2022000212&nbsp;</span>&nbsp;-----&nbsp;&nbsp;Payment amount : Rp 300,000
                    Your ----- Payment was processed by : Bank BCA account PT Mora Pratama Kreasindo (Jarvis Store)</p>
                <p></p>
                <br>
        ...
        <aside>
            <div contenteditable="">
                <center class="small-text">*** Invoice created on 2022-04-21 10:16:13 ***</center>
            </div>
        </aside>
    </body>
