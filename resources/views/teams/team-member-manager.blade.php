<div>
    @if (Gate::check('addTeamMember', $team) || optional($this->user->team)->role == 'admin')
    ...
    @if ($team->teamInvitations->isNotEmpty() && (Gate::check('addTeamMember', $team) || optional($this->user->team)->role == 'admin'))
        <x-jet-section-border />
