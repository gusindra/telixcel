    ...
    public static function map(): array
    {
        return [
            ...
            'contract' => [
                ...
                'permission' => 'CONTRACT',
                'label' => 'Contract',
                'readable' => ['id', 'title', 'status', 'model', 'model_id', 'expired_at', 'actived_at', 'client_id', 'user_id', 'created_at'],
            ...
            'ticket' => [
                ...
                'permission' => 'TICKET',
                'label' => 'Ticket',
                'readable' => ['id', 'status', 'priority', 'reasons', 'solution', 'request_id', 'handled_by', 'forward_to', 'created_at'],
